...
gulp.task('minify-img', function() {
  gulp.src(['app/assets/**/*.{jpg,jpeg,png,gif}', '!app/assets/bower_components/**'])
    .pipe(imagemin())
    .pipe(gulp.dest('dist/assets'));
});
...
// build task
gulp.task('build',
  ['lint', 'minify-css', 'minify-js',  'minify-img', 'copy-html-files', 'copy-bower-components', 'connectDist']
);
